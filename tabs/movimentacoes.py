...
def render(f_code_padded, engine, buscar_func, estilizar_func, to_float_func):
    ...
    # Última entrada e última saída por filial
    ...
    # Separa Empresa e Filial da coluna combinada
    ...
    # Exibe apenas colunas desejadas que existem
    colunas_ok = [c for c in COLUNAS_EXIBIR if c in df_nf.columns]
    df_exibir  = df_nf[colunas_ok]
